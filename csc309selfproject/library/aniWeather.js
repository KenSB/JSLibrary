...
(function(global){
  ...
  const addlightning = function(args){
    let position = 0;
  ...
  const animateRain = function(args){
    let position = 0;
    let rainEntities = '';
    if(args.lightning){
  ...
  const animateSnow = function(args){
    let position = 0;
    let snowEntities = '';
  ...
  const animateClear = function(args){
  ...
  const animateFog = function(args){
    let position = 0;
  ...
  global.AniWeather = global.AniWeather || AniWeather
})(window);
